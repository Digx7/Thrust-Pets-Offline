...
{
    public class GameEndResultChannelListener : MonoBehaviour 
    {
        #region Variables ==============================================
        [SerializeField] private GameEndResultChannel channelToListenTo;

        public GameEndResultEvent onChannelRaised;

        public bool checkLastValueOnStart;
        public bool shouldFilterValue = false;
        public bool shouldPassHeardDataThrough = true;

        public GameEndResult filter;
        public GameEndResult outgoingDataIfNotPassHeardDataThrough;
        #endregion
        ...
        public void OnHearChannel(GameEndResult data)
        {
        ...
        public void SendOutResponse(GameEndResult incomingData)
        {
