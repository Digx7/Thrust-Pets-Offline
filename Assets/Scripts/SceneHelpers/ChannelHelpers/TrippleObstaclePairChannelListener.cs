...
{
    public class TrippleObstaclePairChannelListener : MonoBehaviour 
    {
        #region Variables ==============================================
        [SerializeField] private TrippleObstaclePairChannel channelToListenTo;

        public TrippleObstaclePairEvent onChannelRaised;

        public bool checkLastValueOnStart;
        public bool shouldFilterValue = false;
        public bool shouldPassHeardDataThrough = true;

        public TrippleObstaclePair filter;
        public TrippleObstaclePair outgoingDataIfNotPassHeardDataThrough;
        #endregion
        ...
        public void OnHearChannel(TrippleObstaclePair data)
        {
        ...
        public void SendOutResponse(TrippleObstaclePair incomingData)
        {
