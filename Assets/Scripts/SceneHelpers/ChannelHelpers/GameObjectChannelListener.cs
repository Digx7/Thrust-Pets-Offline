...
{
    public class GameObjectChannelListener : MonoBehaviour 
    {
        #region Variables ==============================================
        [SerializeField] private GameObjectChannel channelToListenTo;

        public GameObjectEvent onChannelRaised;
        ...
        public GameObject outgoingDataIfNotPassHeardDataThrough;
        #endregion
        ...
        public void OnHearChannel(GameObject data)
        {
        ...
        public void SendOutResponse(GameObject incomingData)
        {
