...
{
    // TODO (Optional): Toggle comment if you want to implement a custom Property Drawer for the ScreenInfo Struct
    
    // [CustomPropertyDrawer(typeof(ScreenInfo))]
    // public class ScreenInfoStructPropertyDrawer: PropertyDrawer {
    ...
    //         ScreenInfo myTarget = (ScreenInfo)property.objectReferenceValue;
    ...
    //            EditorGUI.LabelField(spriteMissingPosition, "Error!  No ScreenInfo is set, this will cause a bug", errorStyle);
