...
{
    // TODO (Optional): Toggle comment if you want to implement a custom Property Drawer for the ObstaclesState Struct

//    [CustomPropertyDrawer(typeof(ObstaclesState))]
//    public class ObstaclesStateStructPropertyDrawer: PropertyDrawer {
...
//
//            ObstaclesState myTarget = (ObstaclesState)property.objectReferenceValue;
//
//            if(myTarget != null)
//            {
//                // TODO (Optional): Display custom data here 
...
//                EditorGUI.LabelField(spriteMissingPosition, "Error!  No ObstaclesState is set, this will cause a bug", errorStyle);
//
//            }
//
//
