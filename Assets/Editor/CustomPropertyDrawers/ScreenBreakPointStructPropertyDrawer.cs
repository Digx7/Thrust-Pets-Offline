...
{
    // TODO (Optional): Toggle comment if you want to implement a custom Property Drawer for the ScreenBreakPoint Struct
    ...
    //         ScreenBreakPoint myTarget = (ScreenBreakPoint)property.objectReferenceValue;
    ...
    //            EditorGUI.LabelField(spriteMissingPosition, "Error!  No ScreenBreakPoint is set, this will cause a bug", errorStyle);
