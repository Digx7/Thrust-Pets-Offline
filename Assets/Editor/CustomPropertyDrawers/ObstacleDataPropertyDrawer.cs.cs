...
{
    // TODO (Optional): Toggle comment if you want to implement a custom Property Drawer for the ObstacleData Scriptable Object

//    [CustomPropertyDrawer(typeof(Obstacle))]
//    public class ObstacleStructPropertyDrawer: PropertyDrawer {
...
//
//            ObstacleData myTarget = (ObstacleData)property.objectReferenceValue;
//
//            if(myTarget != null)
//            {
//                // TODO (Optional): Display custom data here 
...
//                EditorGUI.LabelField(spriteMissingPosition, "Error!  No ObstacleData is set, this will cause a bug", errorStyle);
//
//            }
//
//
