...
{
    // TODO (Optional): Toggle comment if you want to implement a custom Property Drawer for the TrippleObstaclePair Struct

//    [CustomPropertyDrawer(typeof(TrippleObstaclePair))]
//    public class TrippleObstaclePairStructPropertyDrawer: PropertyDrawer {
...
//
//            TrippleObstaclePair myTarget = (TrippleObstaclePair)property.objectReferenceValue;
//
//            if(myTarget != null)
//            {
//                // TODO (Optional): Display custom data here 
...
//                EditorGUI.LabelField(spriteMissingPosition, "Error!  No TrippleObstaclePair is set, this will cause a bug", errorStyle);
//
//            }
//
//
